...
def test_one_epoch(task_name, model_name, epoch, total_epoch, model, device, testloader,
    ...
    with torch.no_grad():
        for batch_idx, (inputs, targets, task_idx) in enumerate(loader_tqdm):
            ...
            if wandb_enable and batch_idx == 0:
    ...
    if gate_print and weights_list != [] and weights_list is not None:
        print('w1:', weights_l1)
        print('w2:', weights_l2)
    ...
    if _psnr >= best_psnr and _ssim >= best_ssim:
